...
const int indDefense = 1;
const int indTower = 1;
}
...
void StepGameBuildTower::OnStart()
{
...
void StepGameBuildTower::OnEnd()
{
    ...
    btn = dialog->mSlots->GetButton(indTower);
    btn->RemoveToggleFunction(mButtonStructId);

    btn = dialog->mBtnBuild;
