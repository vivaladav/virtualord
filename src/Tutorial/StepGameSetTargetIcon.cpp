...
constexpr PanelObjectActions::Button btnId = PanelObjectActions::BTN_SET_TARGET;
}

namespace game
{

StepGameSetTargetIcon::StepGameSetTargetIcon(const Game * game, Screen * screen,
    ...
    , mPanelActions(panel)
{
    ...
    info->AddActionEntry(sm->GetCString("TUT_GAME_BUILD_TARGET_ICON"),
...
StepGameSetTargetIcon::~StepGameSetTargetIcon()
{
