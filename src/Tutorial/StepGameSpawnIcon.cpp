...
constexpr PanelObjectActions::Button btnId = PanelObjectActions::BTN_SPAWN;
}

namespace game
{

StepGameSpawnIcon::StepGameSpawnIcon(const Game * game, Screen * screen,
    ...
    , mPanelActions(panel)
{
    ...
    info->AddActionEntry(sm->GetCString("TUT_GAME_BUILD_MU_ICON"),
...
StepGameSpawnIcon::~StepGameSpawnIcon()
{
