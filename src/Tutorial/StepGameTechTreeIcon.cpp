...
constexpr PanelObjectActions::Button btnId = PanelObjectActions::BTN_TECH_TREE;
}

namespace game
{

StepGameTechTreeIcon::StepGameTechTreeIcon(const Game *game, PanelObjectActions * panel,
...
StepGameTechTreeIcon::~StepGameTechTreeIcon()
{
