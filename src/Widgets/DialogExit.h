...
public:
    enum DialogButtons : unsigned int
    {
        ...
        BUTTONS_EXIT_GAME = BTN_MAIN_MENU | BTN_PLANET_MAP | BTN_SETTINGS | BTN_SAVE,
        BUTTONS_EXIT_PLANET = BTN_MAIN_MENU | BTN_SETTINGS | BTN_SAVE,
        BUTTONS_TUTORIAL = BTN_MAIN_MENU | BTN_QUIT_TUTORIAL | BTN_SAVE,
    };
