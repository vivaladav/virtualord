...
// DIALOG CHANGELOG
extern const char SpriteFileDialogChangelog[];

enum SpriteIdDialogChangelog : unsigned int
{
    // CHANGELOG DIALOG
    ID_DLG_CHLG_BG,
    ID_DLG_CHLG_BTN_CLOSE,
    ID_DLG_CHLG_BTN_SCROLLBAR,
    ID_DLG_CHLG_BG_SCROLLBAR,

    // BUTTON UPDATES
    ID_DLG_CHLG_BTN_UP_BG_NORMAL,
    ID_DLG_CHLG_BTN_UP_BG_OVER,
    ID_DLG_CHLG_BTN_UP_BG_PUSHED,
};
...
enum SpriteIdUIShared : unsigned int
{
    ...
    ID_BTN_TAB_CHECKED,
    // BUTTON DIALOG BACK
    ID_BTN_DLG_BACK_NORMAL,
    ID_BTN_DLG_BACK_DISABLED,
    ID_BTN_DLG_BACK_OVER,
    ID_BTN_DLG_BACK_PUSHED,
};
...
enum SpriteIdTutorial : unsigned int
{
    ...
    IND_TUT_PANEL_INFO_ISO_CORNER_TL,
    IND_TUT_PANEL_INFO_ISO_CORNER_TR,
    IND_TUT_PANEL_INFO_ISO_CORNER_BL,
    IND_TUT_PANEL_INFO_ISO_CORNER_BR,
};
